...
int main() {
  emit_text_diff("cos2<alpha>=1-2<times>sin", "cos2<alpha>=1-2<times>sin^2<alpha>");
  cout << "---" << endl;
  emit_text_diff("8<alpha>=1-", "8<alpha>=1-2");
  cout << "---" << endl;
  emit_text_diff("8<alpha>=1-", "8<alpha>=1-2<times>");
  return 0;
}
