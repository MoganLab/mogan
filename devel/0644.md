# [0644] 修复 framed 内部 decorated 块的 HTML 导出问题
...
xmake r stem --headless -c TeXmacs/tests/tmu/0644.tmu test_headless_fixed.html -q
```

#### 手动验证
打开 `TeXmacs/tests/tmu/0644.tmu`，导出 HTML，查看 HTML 渲染效果应与软件内一致
