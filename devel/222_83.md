...
3. 点击 `工具 -> 开发工具`，勾选启用开发工具
4. 再次点击 `查看` 菜单，确认出现 `动画工具栏` 选项
5. 点击 `动画工具栏`，确认底部动画工具栏正常显示和工作
...
## 2026/05/08 将动画工具栏放入开发工具条件分支

### What
将 `查看` 菜单中的 `动画工具栏` 选项移到 `(if (with-developer-tool?) ...)` 条件块内，使其仅在开发工具开启时可见。
