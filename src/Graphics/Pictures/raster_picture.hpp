...
template <typename C> struct picture_kind_helper {
  static picture_kind kind;
};

template <typename C> picture_kind picture_kind_helper<C>::kind= picture_raster;

/******************************************************************************
 * Raster picture class
 ******************************************************************************/

template <class C> class raster_picture_rep : public picture_rep {
public:
  raster<C> r;
