...
using moebius::data::black;
using moebius::data::blend_colors;
using moebius::data::blue;
using moebius::data::brown;
using moebius::data::cmyk_color;
using moebius::data::colorhash;
using moebius::data::dark_grey;
using moebius::data::get_color_attrs;
using moebius::data::get_hex_color;
using moebius::data::get_named_rgb_color;
using moebius::data::get_reverse_colors;
using moebius::data::get_rgb_color;
using moebius::data::green;
using moebius::data::grey;
using moebius::data::initialize_colors;
using moebius::data::is_color_name;
using moebius::data::light_grey;
using moebius::data::magenta;
using moebius::data::named_color;
using moebius::data::named_color_to_xcolormap;
using moebius::data::named_rgb_color;
using moebius::data::orange;
using moebius::data::pastel;
using moebius::data::pink;
using moebius::data::red;
using moebius::data::reverse;
using moebius::data::reverse_colors;
using moebius::data::rgb_color;
using moebius::data::set_color_attrs;
using moebius::data::set_reverse_colors;
using moebius::data::set_true_colors;
using moebius::data::tm_background;
using moebius::data::true_colors;
using moebius::data::white;
using moebius::data::xpm_color;
using moebius::data::yellow;
...
void load_system_font (string family, int size, int dpi, font_metric& fnm,
                       font_glyphs& fng);
...
bool set_selection (string cb, tree t, string s, string sv, string sh,
                    string format);
