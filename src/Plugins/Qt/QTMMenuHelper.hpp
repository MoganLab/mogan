...
/*! Handles TeXmacs commands in the QT way.
 ...
 following:
    ...
    QObject::connect(theQWidget, SIGNAL (somethingHappened()), qtmcmd, SLOT
 (apply()));
 ...
 but making sure that the underlying command_rep is properly sent to the
 mentioned queue.
*/
...
public:
  QTMLineEdit (QWidget* parent, string _type, string _ww, int style= 0,
