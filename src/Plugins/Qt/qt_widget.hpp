...
public:
  ...
  string type_as_string () {
    static const char* qt_widget_type_strings[]= {"none",
                                                  "input_widget",
                                                  "file_chooser",
                                                  "window_widget",
                                                  "view_widget",
...
public:
  ABSTRACT_NULL (
      qt_widget); // Automagically declared constructor, methods, etc.
...
public:
  ...
  virtual widget make_popup_widget () { return headless_widget (); }
  virtual widget popup_window_widget (string s) {
    (void) s;
    return headless_widget ();
  }
