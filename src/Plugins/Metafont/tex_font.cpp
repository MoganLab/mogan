...
static char CM_unaccented[128]= {
    'A',   ' ',   'C',   'C',   'D',   'E', ' ',   'G',  'L', 'L', ' ',   'N',
    'N',   ' ',   'O',   'R',   'R',   'S', 'S',   'S',  'T', 'T', 'U',   'U',
    'Y',   'Z',   'Z',   'Z',   ' ',   'I', 'd',   ' ',  'a', ' ', 'c',   'c',
    'd',   'e',   ' ',   'g',   'l',   'l', ' ',   'n',  'n', ' ', 'o',   'r',
    'r',   's',   's',   's',   't',   't', 'u',   'u',  'y', 'z', 'z',   'z',
    ' ',   '\74', '\76', ' ',   'A',   'A', 'A',   'A',  'A', 'A', '\35', 'C',
    'E',   'E',   'E',   'E',   'I',   'I', 'I',   'I',  'D', 'N', 'O',   'O',
    'O',   'O',   'O',   '\36', '\37', 'U', 'U',   'U',  'U', 'Y', ' ',   ' ',
    'a',   'a',   'a',   'a',   'a',   'a', '\32', 'c',  'e', 'e', 'e',   'e',
    '\20', '\20', '\20', '\20', 'd',   'n', 'o',   'o',  'o', 'o', 'o',   '\33',
    '\34', 'u',   'u',   'u',   'u',   'y', ' ',   '\31'};

static char CM_accents[128]= {
    '\25',  ' ',    '\23',  '\24',  '\24',  '\24',  ' ',    '\25',  '\23',
    '\47',  ' ',    '\23',  '\24',  ' ',    '\175', '\23',  '\24',  '\23',
    '\24',  '\30',  '\24',  '\30',  '\175', '\27',  '\177', '\23',  '\24',
    '\137', ' ',    '\137', '\26',  ' ',    '\25',  ' ',    '\23',  '\24',
    '\24',  '\24',  ' ',    '\25',  '\23',  '\47',  ' ',    '\23',  '\24',
    ' ',    '\175', '\23',  '\24',  '\23',  '\24',  '\30',  '\24',  '\30',
    '\175', '\27',  '\177', '\23',  '\24',  '\137', ' ',    ' ',    ' ',
    ' ',    '\22',  '\23',  '\136', '\176', '\177', '\27',  ' ',    '\30',
    '\22',  '\23',  '\136', '\177', '\22',  '\23',  '\136', '\177', '\26',
    '\176', '\22',  '\23',  '\136', '\176', '\177', ' ',    ' ',    '\22',
    '\23',  '\136', '\177', '\23',  ' ',    ' ',    '\22',  '\23',  '\136',
    '\176', '\177', '\27',  ' ',    '\30',  '\22',  '\23',  '\136', '\177',
    '\22',  '\23',  '\136', '\177', '\26',  '\176', '\22',  '\23',  '\136',
    '\176', '\177', ' ',    ' ',    '\22',  '\23',  '\136', '\177', '\23',
    ' ',    ' '};
...
static char ADOBE_unaccented[128]= {
    ...
    '\350', 'N',    'N',    ' ',    'O', 'R', 'R', 'S',   'S',    'S',
    'T',    'T',    'U',    'U',    'Y', 'Z', 'Z', 'Z',   ' ',    'I',
    'd',    '\247', 'a',    'a',    'c', 'c', 'd', 'e',   'e',    'g',
    'l',    'l',    '\370', 'n',    'n', ' ', 'o', 'r',   'r',    's',
    's',    's',    't',    't',    'u', 'u', 'y', 'z',   'z',    'z',
    ' ',    '\241', '\277', '\243', 'A', 'A', 'A', 'A',   'A',    'A',
    '\341', 'C',    'E',    'E',    'E', 'E', 'I', 'I',   'I',    'I',
    'D',    'N',    'O',    'O',    'O', 'O', 'O', '\36', '\351', 'U',
    'U',    'U',    'U',    'Y',    ' ', ' ', 'a', 'a',   'a',    'a',
    'a',    'a',    '\361', 'c',    'e', 'e', 'e', 'e',   '\365', '\365',
    '\365', '\365', 'd',    'n',    'o', 'o', 'o', 'o',   'o',    '\372',
    '\371', 'u',    'u',    'u',    'u', 'y', ' ', '\373'};

static char ADOBE_accents[128]= {
    '\306', '\316', '\302', '\317', '\317', '\317', '\316', '\306', '\302',
    '\47',  ' ',    '\302', '\317', ' ',    '\315', '\302', '\317', '\302',
    '\317', '\313', '\317', '\313', '\315', '\312', '\310', '\302', '\317',
    '\307', ' ',    '\307', '\305', ' ',    '\306', '\316', '\302', '\317',
    '\317', '\317', '\316', '\306', '\302', '\47',  ' ',    '\302', '\317',
    ' ',    '\315', '\302', '\317', '\302', '\317', '\313', '\317', '\313',
    '\315', '\312', '\310', '\302', '\317', '\307', ' ',    ' ',    ' ',
    ' ',    '\301', '\302', '\303', '\304', '\310', '\312', ' ',    '\313',
    '\301', '\302', '\303', '\310', '\301', '\302', '\303', '\310', '\305',
    '\304', '\301', '\302', '\303', '\304', '\310', ' ',    ' ',    '\301',
    '\302', '\303', '\310', '\302', ' ',    ' ',    '\301', '\302', '\303',
    '\304', '\310', '\312', ' ',    '\313', '\301', '\302', '\303', '\310',
    '\301', '\302', '\303', '\310', '\305', '\304', '\301', '\302', '\303',
    '\304', '\310', ' ',    ' ',    '\301', '\302', '\303', '\310', '\302',
    ' ',    ' '};
...
tex_font_rep::get_glyph (string s) {
  ...
  case TEX_ADOBE:
    ...
    if (s == "<gtr>") s= ">";
    for (i= 0; i < N (s); i++)
      if ((s[i] & 128) != 0) return font_rep::get_glyph (s);
    break;
  }
  int c;
...
struct tfm_font_metric_rep : public font_metric_rep {
  ...
  tfm_font_metric_rep (string name, tex_font_metric tfm2, font_glyphs pk2,
                       double unit2)
      : font_metric_rep (name), tfm (tfm2), pk (pk2), unit (unit2),
        ms (error_metric) {}
  bool exists (int c) { return c >= ((int) tfm->bc) && ((int) tfm->ec) >= c; }
  metric& get (int c) {
