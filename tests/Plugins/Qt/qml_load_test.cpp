...
public:
  ...
  Q_INVOKABLE QString browsePdf (const QString&) { return QString (); }
  Q_INVOKABLE QString browseFolder (const QString&) { return QString (); }
};
...
TestQmlLoad::test_export_pdf_loads () {
  ...
  f0["type"] = QString ("path");
  f0["label"]= QString ("File name:");
  f0["key"]  = QString ("filename");
  f0["value"]= QString ("doc.pdf");
  fields << f0;
  QVariantMap fdir;
  fdir["type"] = QString ("path");
  fdir["label"]= QString ("Location:");
  fdir["key"]  = QString ("folder");
  fdir["value"]= QString ("C:/tmp");
  fields << fdir;
  QVariantMap f1;
  f1["type"] = QString ("number");
  f1["label"]= QString ("First page:");
  ...
  fields << f2;
  QVariantMap f3;
  f3["type"] = QString ("toggle");
  f3["label"]= QString ("Embed TMU source");
  f3["key"]  = QString ("embed");
  f3["value"]= QString ("false");
  fields << f3;
  QStringList buttons;
  buttons << "OK"
          << "Cancel";
