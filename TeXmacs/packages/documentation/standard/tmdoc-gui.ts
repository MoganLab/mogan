...
<\body>
  ...
  <assign|icon|<style-with|src-compact|none|<macro|<style-with|src-compact|all|name>|<style-with|src-compact|none|<case|<style-with|src-compact|all|<equal|<range|<arg|name>|<minus|<length|<arg|name>>|7>|<length|<arg|name>>>|_x4.png>>|<icon-image|<merge|<range|<arg|name>|0|<minus|<length|<arg|name>>|7>>|.svg>>|<equal|<range|<arg|name>|<minus|<length|<arg|name>>|7>|<length|<arg|name>>>|_x2.png>|<icon-image|<merge|<range|<arg|name>|0|<minus|<length|<arg|name>>|7>>|.svg>>|<equal|<range|<arg|name>|<minus|<length|<arg|name>>|4>|<length|<arg|name>>>|.png>|<icon-image|<merge|<range|<arg|name>|0|<minus|<length|<arg|name>>|4>>|.svg>>|<equal|<range|<arg|name>|<minus|<length|<arg|name>>|4>|<length|<arg|name>>>|.xpm>|<icon-image|<merge|<range|<arg|name>|0|<minus|<length|<arg|name>>|4>>|.svg>>|<icon-image|<arg|name>>>>>>>
