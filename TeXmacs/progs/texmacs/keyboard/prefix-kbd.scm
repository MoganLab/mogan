...
(when (and (like-emacs?) (not (os-macos?)))
  (kbd-wildcards pre ("emacs:meta" "A-" #t))
) ;when

(when (and (like-emacs?) (os-macos?))
  (kbd-wildcards pre ("emacs:meta" "M-" #t))
) ;when
...
(when (like-gnome?)
  ...
  (kbd-map ("gnome" "" "Gnome command") ("std" "" "Gnome command"))
...
(when (like-kde?)
  ...
  (kbd-map ("kde" "" "KDE command") ("std" "" "KDE command"))
...
(when (like-windows?)
  ...
  (kbd-map ("windows" "" "Windows command") ("std" "" "Windows command"))
...
(kbd-wildcards ("tilde tilde" "tilde")
 ("hat hat" "hat")
...
(kbd-map (:profile emacs) ("altcmd" "" "Alternate TeXmacs command"))
...
(kbd-map (:mode in-prog?) ("prog" "" "TeXmacs command"))
