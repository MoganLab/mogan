...
(set-font-rules
  '(;; Main math font
    ((math $ecrm $cmr $cmmi $cmsy $msam $msbm $stmary $wasy $line $cal $calstar
       $frak $bbb $bbbcap $upgreek $bold1 $bold2 $boldcal $cmex $s $d)
    ...
    ((math-std $ecrm $cmr $cmmi $s $d)
     (math $ecrm $cmr $cmmi cmsy msam msbm stmary wasy line cmsy rsfs eufm bbm
       bbold grmn cmbx cmmib cmbsy cmex $s $d))
    ((bold-math-std $ecrm $cmr $cmmi $s $d)
     (math $ecrm $cmr $cmmi cmbsy msam msbm stmary wasyb linew cmbsy rsfs eufb
       bbmbx bbold grxn cmbx cmmib cmbsy cmexb $s $d))
    ((math-conc $ecrm $cmr $cmmi $s $d)
     (math $ecrm $cmr $cmmi xccsy xccam xccbm stmary wasy line cmsy rsfs eufm
       bbm bbold grmn cmbx cmmib cmbsy xccex $s $d))
    ((math-bright $ecrm $cmr $cmmi $s $d)
     (math $ecrm $cmr $cmmi cmbrsy cmbram cmbrbm stmary wasy line cmbrsy rsfs
       eufb bbmbx bbold grxn cmbx cmmib cmbsy cmex $s $d))
    ;; Upright math font
    ((var-math $ecrm $cmr $cmmi $cmsy $msam $msbm $stmary $wasy $line $cal
       $calstar $frak $bbb $bbbcap $upgreek $bold1 $bold2 $boldcal $cmex $s $d)
    ...
    ((alt-math $ecrm $ecti $cmr $cmmi $cmsy $msam $msbm $stmary $wasy $line $cal
       $calstar $frak $bbb $bbbcap $upgreek $bold1 $bold2 $boldcal $cmex $s $d)
    ...
    ((math-std $ecrm $cmr $cmmi $s $d)
     (math $ecrm $cmr $cmmi cmsy msam msbm stmary wasy line cmsy rsfs eufm bbm
       msbm grmn cmbx cmmib cmbsy cmex $s $d))
    ((bold-math-std $ecrm $cmr $cmmi $s $d)
     (math $ecrm $cmr $cmmi cmbsy msam msbm stmary wasyb linew cmbsy rsfs eufb
       bbmbx msbm grxn cmbx cmmib cmbsy cmexb $s $d))
    ((math-conc $ecrm $cmr $cmmi $s $d)
     (math $ecrm $cmr $cmmi xccsy xccam xccbm stmary wasy line cmsy rsfs eufm
       bbm msbm grmn cmbx cmmib cmbsy xccex $s $d))
    ((math-bright $ecrm $cmr $cmmi $s $d)
     (math $ecrm $cmr $cmmi cmbrsy cmbram cmbrbm stmary wasy line cmbrsy rsfs
       eufb bbmbx msbm grxn cmbx cmmib cmbsy cmex $s $d))
    ((math-var $ecrm $cmr $cmmi $s $d)
     (var-math $ecrm $cmr $cmmi cmsy msam msbm stmary wasy line cmsy rsfs eufm
       bbm bbold grmn cmbx cmmib cmbsy cmex $s $d))
    ((bold-math-var $ecrm $cmr $cmmi $s $d)
     (var-math $ecrm $cmr $cmmi cmbsy msam msbm stmary wasyb linew cmsy rsfs
       eufm bbmbx bbold grxn cmbx cmmib cmbsy cmexb $s $d))
    ((math-conc-var $ecrm $cmr $cmmi $s $d)
     (var-math $ecrm $cmr $cmmi xccsy xccam xccbm stmary wasy line cmsy rsfs
       eufm bbm bbold grmn cmbx cmmib cmbsy xccex $s $d))
    ((math-bright-var $ecrm $cmr $cmmi $s $d)
     (var-math $ecrm $cmr $cmmi cmbrsy cmbram cmbrbm stmary wasy line cmbrsy
       rsfs eufm bbm bbold grmn cmbx cmmib cmbsy cmex $s $d))
    ((math-alt $ecrm $ecti $cmr $cmmi $s $d)
     (alt-math $ecrm $ecti $cmr $cmmi cmsy msam msbm stmary wasy line cmsy rsfs
       eufm bbm bbold grmn cmbx cmmib cmbsy cmex $s $d))
    ((bold-math-alt $ecrm $ecti $cmr $cmmi $s $d)
     (alt-math $ecrm $ecti $cmr $cmmi cmbsy msam msbm stmary wasyb linew cmbsy
       rsfs eufb bbmbx bbold grxn cmbx cmmib cmbsy cmexb $s $d))
    ((math-conc-alt $ecrm $ecti $cmr $cmmi $s $d)
     (alt-math $ecrm $ecti $cmr $cmmi xccsy xccam xccbm stmary wasy line cmsy
       rsfs eufm bbm bbold grmn cmbx cmmib cmbsy xccex $s $d))
...
(set-font-rules
  '(((capital-math $name $ecrm $cmr $cmmi $cmsy $msam $msbm $stmary $wasy $line
       $cal $calstar $frak $bbb $bbbcap $upgreek $bold1 $bold2 $boldcal $cmex $s
       $d)
    ...
    ((math-capital $name $s $d)
     (capital-math $name ecrm cmr cmmi cmsy msam msbm stmary wasy line cmsy rsfs
       eufm bbm bbold grmn cmbx cmmib cmbsy cmex $s $d))
...
(set-font-rules
  '(((alphanum-math $name $ecrm $cmr $cmmi $cmsy $msam $msbm $stmary $wasy $line
    ...
    ((math-alphanum $name $s $d)
     (alphanum-math $name ecrm cmr cmmi cmsy msam msbm stmary wasy line cmsy
       rsfs eufm bbm bbold grmn cmbx cmmib cmbsy cmex $s $d))
...
(set-font-rules
  '(((enr-math $name $ecrm $cmr $cmmi $cmsy $msam $msbm $stmary $wasy $line $cal
       $calstar $frak $bbb $bbbcap $upgreek $bold1 $bold2 $boldcal $cmex $s $d)
     (math (enr-math (tex $cmr $s $d)
       ...
       (ec ecrm $s $d)))
    ((math-enr $name $s $d)
     (enr-math $name ecrm cmr cmmi cmsy msam msbm stmary wasy line cmsy rsfs
       eufm bbm bbold grmn eurb eurb cmbsy cmex $s $d))
    ((bold-math-enr $name $s $d)
     (enr-math $name ecbx cmbx cmmib cmbsy msam msbm stmary wasyb linew cmbsy
       rsfs eufb bbmbx bbold grxn eurb eurb cmbsy cmexb $s $d))
...
(set-font-rules
  '(((unicode-math $up $it $bup $bit $t $a $b $s $d)
    ...
    ((math-bonum $t $a right $s $d)
     (unicode-math texgyrebonum-math texgyrebonum-math texgyrebonum-bold
       texgyrebonum-bold $t $a $b $s $d))
    ...
    ((math-bonum $t $a $b $s $d)
     (unicode-math texgyrebonum-math texgyrebonum-italic texgyrebonum-bold
       texgyrebonum-bolditalic $t $a $b $s $d))
    ...
    ((math-pagella $t $a right $s $d)
     (unicode-math texgyrepagella-math texgyrepagella-math texgyrepagella-bold
       texgyrepagella-bold $t $a $b $s $d))
    ...
    ((math-pagella $t $a $b $s $d)
     (unicode-math texgyrepagella-math texgyrepagella-italic texgyrepagella-bold
       texgyrepagella-bolditalic $t $a $b $s $d))
    ...
    ((math-schola $t $a right $s $d)
     (unicode-math texgyreschola-math texgyreschola-math texgyreschola-bold
       texgyreschola-bold $t $a $b $s $d))
    ...
    ((math-schola $t $a $b $s $d)
     (unicode-math texgyreschola-math texgyreschola-italic texgyreschola-bold
       texgyreschola-bolditalic $t $a $b $s $d))
    ...
    ((math-termes $t $a right $s $d)
     (unicode-math texgyretermes-math texgyretermes-math texgyretermes-bold
       texgyretermes-bold $t $a $b $s $d))
    ...
    ((math-termes $t $a $b $s $d)
     (unicode-math texgyretermes-math texgyretermes-italic texgyretermes-bold
       texgyretermes-bolditalic $t $a $b $s $d))
    ((math-stix $t bold right $s $d)
     (unicode-math STIX-Bold STIX-Bold STIX-Bold STIX-Bold $t bold $b $s $d))
    ((math-stix $t $a right $s $d)
     (unicode-math STIX-Regular STIX-Regular STIX-Bold STIX-Bold $t $a $b $s $d))
    ((math-stix $t bold $b $s $d)
     (unicode-math STIX-Bold STIX-BoldItalic STIX-Bold STIX-BoldItalic $t bold
       $b $s $d))
    ((math-stix $t $a $b $s $d)
     (unicode-math STIX-Regular STIX-Italic STIX-Bold STIX-BoldItalic $t $a $b
       $s $d))
    ((math-asana $t $a $b $s $d)
     (unicode-math Asana-Math Asana-Math Asana-Math Asana-Math $t $a $b $s $d))
    ((math-lucida $t $a $b $s $d)
     (unicode-math LucidaGrande LucidaGrande LucidaGrande LucidaGrande $t $a $b
       $s $d))
    ((math-apple $t $a $b $s $d)
     (unicode-math #{Apple Symbols}# #{Apple Symbols}# #{Apple Symbols}# #{Apple
       Symbols}# $t $a $b $s $d))
    ...
    ((math-dejavu ms $a right $s $d)
     (unicode-math DejaVuSans DejaVuSans DejaVuSans-Bold DejaVuSans-Bold ms $a
       $b $s $d))
    ((math-dejavu ms bold $b $s $d)
     (unicode-math DejaVuSans-Bold DejaVuSans-BoldOblique DejaVuSans-Bold
       DejaVuSans-BoldOblique ms bold $b $s $d))
    ...
    ((math-dejavu mt bold right $s $d)
     (unicode-math DejaVuSansMono-Bold DejaVuSansMono-Bold DejaVuSansMono-Bold
       DejaVuSansMono-Bold mt bold $b $s $d))
    ((math-dejavu mt $a right $s $d)
     (unicode-math DejaVuSansMono DejaVuSansMono DejaVuSansMono-Bold
       DejaVuSansMono-Bold mt $a $b $s $d))
    ((math-dejavu mt bold $b $s $d)
     (unicode-math DejaVuSansMono-Bold DejaVuSansMono-BoldOblique
       DejaVuSansMono-Bold DejaVuSansMono-BoldOblique mt bold $b $s $d))
    ((math-dejavu mt $a $b $s $d)
     (unicode-math DejaVuSansMono DejaVuSansMono-Oblique DejaVuSansMono-Bold
       DejaVuSansMono-BoldOblique mt $a $b $s $d))
    ((math-dejavu $t bold right $s $d)
     (unicode-math DejaVuSerif-Bold DejaVuSerif-Bold DejaVuSerif-Bold
       DejaVuSerif-Bold $t bold $b $s $d))
    ((math-dejavu $t $a right $s $d)
     (unicode-math DejaVuSerif DejaVuSerif DejaVuSerif-Bold DejaVuSerif-Bold $t
       $a $b $s $d))
    ((math-dejavu $t bold $b $s $d)
     (unicode-math DejaVuSerif-Bold DejaVuSerif-BoldItalic DejaVuSerif-Bold
       DejaVuSerif-BoldItalic $t bold $b $s $d))
