...
(tm-define (parser-feature lan key)
  ...
  `(,(string->symbol key)
    (constant "false" "true" "cout" "cin" "cerr" "null" "nullptr" "nullptr_t"
      "NULL")
    (constant_type "bool" "byte" "char" "char16_t" "char32_t" "char8_t" "double"
      "float" "int" "int16_t" "int32_t" "int8_t" "long" "short" "signed"
      "uint16_t" "uint32_t" "uint8_t" "unsigned" "void" "wchar_t")
    (declare_type "class" "interface" "enum")
    (declare_module "namespace" "using")
    (keyword "asm" "auto" "calloc" "class" "concept" "concrete" "const"
      ...
      "register" "reinterpret_cast" "sizeof" "static" "static_cast" "struct"
      "template" "this" "to" "typedef" "typeid" "typename" "union" "virtual"
      "volatile")
...
(tm-define (parser-feature lan key)
  ...
  `(,(string->symbol key)
    (directives "define" "undef" "include" "if" "ifdef" "ifndef" "else" "elif"
