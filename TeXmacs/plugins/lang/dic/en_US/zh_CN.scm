...
("Export as PNG..." "导出为 PNG...")
("Export graphics as PNG" "导出图形为 PNG")
...
("Preview the bibliography format here" "此处预览参考文献的格式")
("Invalid BibTeX file" "无效的 BibTeX 文件")
...
("please translate the above text into" "请翻译上述文字为")
("please wait" "请稍后")
("please" "")
