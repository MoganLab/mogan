...
("You are using v%1. The latest stable version of Mogan STEM is v%2, and the latest stable version of Liii STEM is v%3." "您正在使用 v%1。Mogan STEM 的最新稳定版是 v%2，Liii STEM 的最新稳定版是 v%3。")
("You are using v%1. The latest stable version of Mogan STEM is v%2, and the latest stable version of Liii STEM is v%3. Please click OK to visit the official website to download the latest stable version." "您正在使用 v%1。Mogan STEM 的最新稳定版是 v%2，Liii STEM 的最新稳定版是 v%3。请点击确认前往官网下载最新稳定版。")
("You are using v%1, and the latest stable version of Liii STEM is v%2." "您正在使用 v%1，Liii STEM 的最新稳定版是 v%2。")
("You are using v%1, and the latest stable version of Liii STEM is v%2. Please click OK to visit the official website to download the latest stable version." "您正在使用 v%1，Liii STEM 的最新稳定版是 v%2。请点击确认前往官网下载最新稳定版。")
("Login Now" "立即登录")
("User Center" "用户中心")
