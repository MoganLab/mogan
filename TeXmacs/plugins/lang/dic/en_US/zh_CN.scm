...
("Login" "登录")
("Upgrade" "升级")
("Visible only when semantic editing is on" "仅 semantic editing 开时可见")
("Toggling refreshes related fields' visibility" "切换会刷新相关字段可见性")
...
("Visible only when source tracking is on" "仅 source-tracking 开时可见")
