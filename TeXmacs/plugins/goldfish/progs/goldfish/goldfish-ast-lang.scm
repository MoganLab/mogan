...
(texmacs-module (goldfish goldfish-ast-lang)
...
(tm-define (parser-feature lan key)
  ...
  `(,(string->symbol key)
    ...
    (declare_type ,@(r7rs-keywords-define) ,@(liii-keywords-define))
...
(tm-define (parser-feature lan key)
  ...
  `(,(string->symbol key) (tokenize "symbol" "first_symbol"))
) ;tm-define
